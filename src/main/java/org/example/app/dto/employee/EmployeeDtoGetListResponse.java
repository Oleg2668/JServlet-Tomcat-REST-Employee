...
public record EmployeeDtoGetListResponse(
    ...
    public static org.example.app.dto.employee.EmployeeDtoGetListResponse of(boolean isEmployeeListEmpty, List<Employee> employeeList) {
        if (isEmployeeListEmpty)
            return new org.example.app.dto.employee.EmployeeDtoGetListResponse(
