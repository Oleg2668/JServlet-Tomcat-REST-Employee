...
public record EmployeeDtoUpdateResponse(
    ...
    public static org.example.app.dto.employee.EmployeeDtoUpdateResponse of(Long id, boolean isEmployeeFound, Employee employeeUpdated) {
        if (isEmployeeFound)
            return new org.example.app.dto.employee.EmployeeDtoUpdateResponse(
