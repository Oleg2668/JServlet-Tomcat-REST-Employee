...
public record EmployeeDtoDeleteResponse(
    ...
    public static org.example.app.dto.employee.EmployeeDtoDeleteResponse of(Long id, boolean isEmployeeFound) {
        if (isEmployeeFound)
            return new org.example.app.dto.employee.EmployeeDtoDeleteResponse(
